...
export const CommandTip_English = {
	...
	ifdef: { comment: "If a label or macro has been defined", format: ".IFDEF label or macro\n...\n.ELSE\n...\n.ENDIF" },
	ifndef: { comment: "If a label or macro has been not defined", format: ".IFNDEF label or macro\n...\n.ELSE\n...\n.ENDIF" },
	hex: {
