...
export class asm6502 extends IPlatform<typeof asm6502_AddressType> {
	...
	private AddBaseInstructions(): void {
		...
		this.AddInstruction("BEQ", undefined, undefined, [0xF0, "Conditional"]);
		this.AddInstruction("BNE", undefined, undefined, [0xD0, "Conditional"]);
		this.AddInstruction("BCS", undefined, undefined, [0xB0, "Conditional"]);
		this.AddInstruction("BCC", undefined, undefined, [0x90, "Conditional"]);
		this.AddInstruction("BMI", undefined, undefined, [0x30, "Conditional"]);
		this.AddInstruction("BPL", undefined, undefined, [0x10, "Conditional"]);
		this.AddInstruction("BVS", undefined, undefined, [0x70, "Conditional"]);
		this.AddInstruction("BVC", undefined, undefined, [0x50, "Conditional"]);
